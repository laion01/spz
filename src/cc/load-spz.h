...
bool saveSplatToPly(const spz::GaussianCloud &data, const std::string &filename, bool includeNormals);
...
// Loads Gaussian splat data from the raw buffer
GaussianCloud loadSplatFromMemory(const std::vector<char> &buffer);
